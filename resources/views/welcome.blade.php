...
<head>
    ...
    <link href="{{ url('css/styleWelcome.css') }}" rel="stylesheet">
    <link rel="stylesheet"
    ...
    <body>
        ...
        <body>
                ...
                <div class="container">
                    ...
                    <div class="row min-vh-100 align-items-center text-center text-md-left">
                        ...
                        <div class="col-md-6 pr-md-5" data-aos="zoom-in">
                            <img src="img/home-img.svg" width="100%" alt="">
                        </div>
                    ...
                    <div class="row min-vh-100 align-items-center">
                        ...
                        <div class="col-md-6 content" data-aos="fade-right">
                            ...
                            <div class="box">
                                ...
                                <p>The company itself is a very successful company. herself
                                    takes up.</p>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="box-container">
                        ...
                        <div class="box" data-aos="zoom-in">
                            <a href="img/img1.jpg" title="our team">
                                <img src="img/img1.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img2.jpg" title="our lab">
                                <img src="img/img2.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img3.jpg" title="emergency rooms">
                                <img src="img/img3.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img4.jpg" title="expert doctors">
                                <img src="img/img4.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img5.jpg" title="expert doctors">
                                <img src="img/img5.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img6.jpg" title="emergency rooms">
                                <img src="img/img6.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img7.jpg" title="expert doctors">
                                <img src="img/img7.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img8.jpg" title="emergency rooms">
                                <img src="img/img8.jpg" alt="">
                            </a>
                        </div>

                        <div class="box" data-aos="zoom-in">
                            <a href="img/img9.jpg" title="enough beds">
                    ...
                    <div class="box-container">
                        ...
                        <div class="box" data-aos="fade-right">
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consectetur
                                accusantium error numquam dolore atque. Atque totam ad sint ducimus!
                                Maxime!</p>
                    ...
                    <div class="box-container">
                        ...
                        <div class="box" data-aos="fade-right">
                            ...
                            <div class="content">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae ex
            ...
            <section class="footer">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" data-aos="fade-right">
                            <a href="#" class="logo"><span>D</span>r <span>H</span>ouse.</a>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tenetur
                                nemo porro quasi minima consequuntur dolorum, quas amet in autem id?
                            </p>
                        </div>
                ...
                <h1 class="credit text-center mx-auto">created by <span>mr. web designer</span> |
