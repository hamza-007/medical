    ...
    <div class="sidebar">
        ...
        <div class="profile">
            <div class="profile-img">
                <img src="img/doctors-set-team-medical-workers-260nw-1014822766.webp" alt="">
            </div>
            <div class="name">
                <h1>
                    Staff medical </h1>
        ...
        <div class="main-posts">
            ...
            <div class="post-box">
                ...
                <div class="post-info">
                    ...
                    <div class="likes">
                        <a href="calendrier/calendrier.html" class="icon" > <i class="ri-calendar-todo-fill"></i></a>

                        <a href="#" class="icon"><i class="ri-file-copy-2-line"></i></a>
